...
<html>
  <head>
       <title> Chapter 2 Transmission Media </title>
	 	<link rel="shortcut icon" href="pictures/mainlogin/mmuicon.png" />
	   <link rel="stylesheet" href="css/mainpagecss.css" >
	  <link rel="stylesheet" href="css/dcn_2.0.css" >
...
<div class="prevpg">
<a href="dcn_1.5.php"><img src="pictures/prevch.png" width="200" height="200"></a>
</div>
	<p style="font-size:30px; position:absolute; left:650;top:-20;"><img src="pictures/dcn1/overview.png" width="450" height="150"> </p>
	<img src="pictures/dcn2/line.png" alt="Intro chart" style="width:900px;height:390px;position:absolute; top:170; left:400;">
  <div class="one"> <a href="dcn_2.0.php"><img src="pictures/dcn2/1.png"></a></div>
  <div class="two"> <a href="dcn_2.1.php"><img src="pictures/dcn2/2.png"></a></div>
   <div class="three"> <a href="dcn_2.2.php"><img src="pictures/dcn2/3.png"></a></div>
    <div class="four"> <a href="dcn_2.3.php"><img src="pictures/dcn2/4.png"></a></div>
...
<div id="two" class="content">
  ...
  <li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp; To introduce the transmission media and defines its position in the Internet model. </li>
  <br>
  <li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;To discuss on guided media. </li>
  <br>
  <li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;To discuss unguided media.</li>
  <br>


</ul>  
<div class="nextpg">
<a href="dcn_2.1.php"><img src="pictures/next.png" width="200" height="200"></a>
</div>
</div>
