...
<html>
  <head>
       <title> Chapter 1.1 Data Communications </title>
...
<div class="prevpg">
<a href="dcn_1.0.php"><img src="pictures/prev.png" width="200" height="200"></a>
</div>
<p style="font-size:25px;position:absolute;top:-20;left:700;"> Chapter 1.1 Data Communications </p>
<img src="pictures/dcn1.1/telecommunication.jpg" width="700" height="400" style="position:absolute; top:20;left:600;">
<div style="position:absolute; top:450;left:550;">
<ul class="obj">
<li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;Telecommunication means communication at a distance which includes telephony, telegraph, and television. 
</li>
  <br>
  <li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;Data communications are the exchange of data between two devices via some form of transmission media. </li>
...
<img src="pictures/dcn1.1/transmed.png" width="700" height="300" style="position:absolute; top:0;left:600;">
<div style="position:absolute; top:300;left:620;">
<p style="font-size:25px;"> Five components of data communication system: </p>
<ul class="obj">
<li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;Sender</li> 
</li>
  <br>
  <li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;Receiver</li>
  <br>
  <li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;Message</li>
    <br>
  <li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;Protocol</li>
    <br>
  <li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;Transmission Medium</li>
</ul>
</div>
</div>

<div id="three" class="content">
<img src="pictures/dcn1.1/duplex.png" width="700" height="300" style="position:absolute; top:0;left:600;">
<p style="font-size:25px; position:absolute; top:350; left:550;">Communication between two devices can be simplex, half-duplex, or full-duplex. </p>
<div class="nextpg">
<a href="dcn_1.2.php"><img src="pictures/next.png" width="200" height="200"></a>
</div>
</div>
