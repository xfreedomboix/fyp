...
<html>
  <head>
       <title> Chapter 1.5 OSI PROTOCOL SUITE </title>
...
<div class="prevpg">
<a href="dcn_1.4.php"><img src="pictures/prev.png" width="200" height="200"></a>
</div>
<div id="page">
<p style="font-size:25px;position:absolute;top:-20;left:550;"> Chapter 1.5 OSI Protocol Suite</p>
<img src="pictures/dcn1.5/osi.png" width="450" height="600" style="position:absolute; top:60;left:650;">
</div>
</div>


<div id="two" class="content">
<img src="pictures/dcn1.5/versus.png" width="550" height="500" style="position:absolute; top:0;left:650;">
<div style="position:absolute; top:500;left:400;">
<ul class="obj">
<li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;When we compare the two models, we find that two layers, session and presentation, are missing from the TCP/IP protocol suite. 
</li></br> 
<li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;These two layers were not added to the TCP/IP protocol suite after the publication of the OSI model. 
</li> </br>
  <li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;The application layer in the suite is usually considered to be the combination of three layers in the OSI model.</li>
</ul>
</div>
<div class="nextpg">
<a href="dcn_2.0.php"><img src="pictures/nextch.png" width="200" height="200"></a>
</div>
</div>
...
<div class="cmt" style="left:910"> <a href="#comment"> Discussions</a> </div>
