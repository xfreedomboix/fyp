...
<html>
  <head>
       <title> Chapter 1.3 Networks Types</title>
...
<div class="prevpg">
<a href="dcn_1.2.php"><img src="pictures/prev.png" width="200" height="200"></a>
</div>
<p style="font-size:25px;position:absolute;top:-20;left:450;"> Chapter 1.3 Networks Types</p>
<img src="pictures/dcn1.3/lanwan.png" width="800" height="400" style="position:absolute; top:20;left:450;">
<div style="position:absolute; top:450;left:400;">
<ul class="obj">
<li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;Local Area Network (LAN) is usually privately owned and connects some hosts in a single office, building, or campus. 
</li>
<li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;LAN seperated by geographic distance are connected by a network known as Wide Area Network (WAN). 
</li>
</ul>
</div>
</div>
...
<p style="font-size:25px;">LAN VS WAN </p>
<table class="teachtable">
<thead><tr><th class="blue">&nbsp; LAN </th><th class="blue">&nbsp; WAN </th></tr></thead>
<tr><td> &nbsp;A LAN is normally limited in size </td><td>&nbsp;A WAN has a wider geographical span, spanning a &nbsp;town, a state, a country, or even the world.</td></tr>
<tr><td>&nbsp;A LAN interconnects hosts</td><td>&nbsp;A WAN interconnects connecting devices such as &nbsp;switches, routers, or modems. </td></tr>
<tr><td>&nbsp;A LAN is normally privately owned by &nbsp;the organization that uses it. </td><td>&nbsp;A WAN is normally created and run by &nbsp;communication companies and leased by an&nbsp; organization that uses it. </td></tr>
</table>
<img src="pictures/dcn1.3/versus.png" width="700" height="450" style="position:absolute; left:700;top:250;">
</div>
</div>

<div id="three" class="content">
<p style="font-size:30px; position:absolute; top:50; left:200;">Switching</p>
<img src="pictures/dcn1.3/switch.png" width="1200" height="400" style="position:absolute; top:100;left:200;">
<ul class="obj" style="position:absolute; top:550;left:300;">
<li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;An internet is a switched network in which a switch connects at least two links together. 

</li>
<li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;A switch needs to forward data from a network to another network when required. 
</li>
<li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;The two most common types of switched networks are circuit-switched and packet-switched networks. 
</li>
</ul>
...
<div class="nextpg">
<a href="dcn_1.4.php"><img src="pictures/next.png" width="200" height="200"></a>
</div>
</div>
