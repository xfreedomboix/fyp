...
<video width="800" height="555" style="background-color:black;" controls>
  <source src="video/ch2.mp4" type="video/mp4">
  Your browser does not support HTML5 video.
</video>
	
<p style="position:absolute; top:550;left:40;"><font style="font-size:25px;font-weight:bold;"> Transmission Media (Guided)</font></p>
<p style="position:absolute; top:640;left:40;"><font style="font-size:20px;font-weight:bold;"> Description</font></p>
<p style="position:absolute; top:670;left:40;max-width:750;"><font style="font-size:20px"> This video covers Chapter 2.2 Guided Media where coaxial cable, twisted-pair cable and fiber-optic cable are discussed. </font></p>
</div>
<div id="two" class="content">
<div class="vidtwo">
<iframe width="760" height="555" src="https://www.youtube.com/embed/X2infMqOoEA" frameborder="0" allowfullscreen></iframe>
</div>
<p style="position:absolute; top:550;left:40;"><font style="font-size:25px;font-weight:bold;"> Transmission Media (Unguided)</font></p>
<p style="position:absolute; top:640;left:40;"><font style="font-size:20px;font-weight:bold;"> Description</font></p>
<p style="position:absolute; top:670;left:40;max-width:750;"><font style="font-size:20px"> This video covers Chapter 2.3 Unguided Media where Radiowave, Microwave and Infrared are discussed. </font></p>
</div>
...
<div class="cmt" style="left:900;"> <a href="#comment"> Discussions</a> </div>
