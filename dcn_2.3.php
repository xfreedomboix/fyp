...
<html>
  <head>
       <title> Chapter 2.3 Unguided Media </title>
...
<p style="font-size:25px;position:absolute;top:-20;left:700;"> Unguided Media </p>
<div id="page">
<a href="two.html"><img src="pictures/dcn2/radio.png"  height="170" style="position:absolute; top:20;left:400;"></a>
<a href="three.html"><img src="pictures/dcn2/microwave.png"  height="170" style="position:absolute; top:20;left:500;"></a>
<a href="four.html"><img src="pictures/dcn2/infra.png"  height="170" style="position:absolute; top:22;left:1102;"></a>
</div>
<div style="position:absolute; top:280;left:430;">
<ul class="obj">
<li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;Unguided medium transport waves without using a physical conductor (wireless communication). 
</li></br>
<li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;Signals are normally broadcast through free space. 
</li> </br>
<li style="font-size:20px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;Click on the three different spectrum above to learn more! 
</li>
</ul>
</div>
</div>
...
<p style="font-size:25px;position:absolute;top:0;left:350;"> Radio waves </p>
<img src="pictures/dcn2/radio.png" height="170" style="position:absolute; top:80;left:350;">
<div style="position:absolute; top:280;left:350;">
<p style="font-size:25px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp; Although there is no clear-cut demarcation between radio waves and microwaves, </br>electromagnetic waves ranging in frequencies between 3 kHz and 1 GHz are normally called radio waves.
</p>
...
<p style="font-size:25px;position:absolute;top:0;left:380;"> Microwaves </p>
<img src="pictures/dcn2/microwave1.png" height="170" style="position:absolute; top:80;left:380;">
<div style="position:absolute; top:320;left:390;">
<p style="font-size:25px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp; Electromagnetic waves having frequencies between 1 and 300 GHz are called microwaves.</br> Microwaves are unidirectional. 
</p>
<p style="font-size:25px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;When an antenna transmits microwaves, they can be narrowly focused. </br>This means that the sending and receiving antennas need to be aligned. 
</p>
</div>
</div>

<div id="four" class="content">
<p style="font-size:25px;position:absolute;top:0;left:380;"> Infrared </p>
<img src="pictures/dcn2/infra1.png" height="170" style="position:absolute; top:80;left:380;">
<div style="position:absolute; top:340;left:390;">
<p style="font-size:25px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;Infrared waves, with frequencies from 300 GHz to 400 THz can be used for short-range communication. 
</p>
<p style="font-size:25px;"><img src="pictures/dcn1/tick.png" width="20" height="20">&nbsp;Infrared waves, having high frequencies, cannot penetrate walls. </br>This advantageous characteristic prevents interference between one system and another;  </p>

</div>
<div class="nextpg">
<a href="dcn_3.0.php"><img src="pictures/nextch.png" width="200" height="200"></a>
</div>
</div>
